        ...
        <div class="col-md-12">
            <div class="panel">
                <div class="panel-heading">
                    ...
                    <a href="{{ URL::to('admin/patient_export')}}" class="btn btn-outline-success" style="margin-left: 80%; margin-top: -5%; background-color: rgb(14, 161, 71); color: white;">File Excel</a>
                    <a href="{{ URL::to('admin/patient_report')}}" class="btn btn-outline-success" style="margin-left: 90%; margin-top: -8.2%; background-color: rgb(232, 71, 71); color: white;">File PDF</a>
                </div>
                @if (session('success'))
                                ...
                                <tbody>
                                    ...
                                    <td>
                                        <a onclick="return confirm('Bạn có muốn xóa bệnh nhân {{$pat_list->patient_name}}?');"
                                            href="{{ URL::to('admin/delete_patient/' . $pat_list->patient_id) }}"
