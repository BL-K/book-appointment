...
@section('content')
    <h1 class="page-title">Cập nhật bệnh viện</h1>
    <hr style="height:2px; background-color:gray;">

    <div class="col-md-12 top-20 padding-0">
        <div class="col-md-12">
            <form name="add_form" method="POST" action="{{ URL::to('admin/update_hospital/' . $user->id) }}"
                enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="panel-heading">
                    <h3>Cập nhật bệnh viện</h3>
                </div>
                @if (session('success'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="hospital_contact" type="tel"
                                    ...
                                    name="hospital_contact" value="{{ $user->hospital->hospital_contact }}" required autofocus>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="hospital_url" type="url"
                                    ...
                                    value="{{ $user->hospital->hospital_url }}" required placeholder="www.example.com" autofocus>
                                @error('hospital_url')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-md-4">
                                    <div class="imageupload">
                                        <img src="{{ URL::to('public/' . $user->hospital->hospital_image) }}"
                                            ...
                                            alt="Hình ảnh bệnh viện" title="Hình ảnh bệnh viện">
                    ...
                    <div class="panel-body">
                        <div class="form-group col-md-6">
                            ...
                            <input id="hospital_address" type="text"
                                ...
                                name="hospital_address" value="{{ $user->hospital->hospital_address }}" required autofocus>
