                                ...
                                <li>
                                    <div class="search">
                                        <input type="text" id="keyword" name="keyword" class="form-control"
                                            placeholder="Tìm kiếm" required style="width: 400px;">
                                        <button type="submit" class="btn btn-primary"
                                            style="margin-top: -70px; margin-left: 405px; height: 45px; width: 45px;"><i
                                    ...
                                    <div class="doctor-widget">
                                        <div class="doc-info-left">
                                            <div class="doctor-img">
                                                <a href="{{ URL::to('doctor_detail/' . $doc_list->doctor_id) }}">
                                                    <img src="{{ URL::to('public/' . $doc_list->doctor_avatar) }}"
                                                        class="img-fluid" alt="Hình ảnh bác sĩ">
                                                </a>
                                            </div>
                                            <div class="doc-info-cont">
                                                ...
                                                <p class="doc-department">Chuyên khoa: {{ $doc_list->speciality_name }}</p>
                                        ...
                                        <div class="doc-info-right">
                                            <div class="clinic-booking">
                                                <a class="view-pro-btn"
                                                    href="{{ URL::to('doctor_detail/' . $doc_list->doctor_id) }}">Thông
                                                    tin</a>
                                                <a class="apt-btn"
