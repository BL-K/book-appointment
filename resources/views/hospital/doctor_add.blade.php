...
@section('content')
    <h1 class="page-title">Tạo bác sĩ</h1>
    <hr style="height:2px; background-color:gray;">

    <div class="col-md-12 top-20 padding-0">
        <div class="col-md-12">
            <form name="regform" method="POST" action="{{ URL::to('hospital/insert_doctor') }}" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="doctor_name" id="doctor_name"
                                        ...
                                        value="{{ old('doctor_name') }}" required autocomplete="doctor_name">
                                    @error('doctor_name')
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="speciality_name" id="speciality_name" class="form-control selectpicker"
                                        ...
                                        @foreach ($hospital_speciality as $spe_list)
                                            <option value="{{ $spe_list->speciality_name }}">{{ $spe_list->speciality_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" name="doctor_experience" id="doctor_experience"
                                        class="form-control @error('doctor_experience') is-invalid @enderror"
                                        value="{{ old('doctor_experience') }}" required autocomplete="doctor_experience">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="card col-md-3">
                                        <div class="imageupload">
                                            <img src="{{ URL::to('admin_hospital/img/avatar.jpg') }}"
                                            ...
                                            <div class="file-tab" style="width: 290px;">
                                                <input type="file" name="doctor_avatar" id="doctor_avatar"
                                                    class="form-control @error('doctor_avatar') is-invalid @enderror"
                                                    value="{{ old('doctor_avatar') }}" required
                                                    autocomplete="doctor_avatar" accept="image/*"
                                ...
                                <div class="col-sm-8">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date" name="doctor_dob" id="datepicker" max="{{ date("Y-m-d") }}"
                                                ...
                                                value="{{ old('doctor_dob') }}" required autocomplete="doctor_dob">
                                            @error('doctor_dob')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="doctor_gender" name="doctor_gender"
                                                            class="custom-control-input @error('doctor_gender') is-invalid @enderror"
                                                            value="Nam">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="tel" name="doctor_contact" id="doctor_contact"
                                                class="form-control @error('doctor_contact') is-invalid @enderror"
                                                value="{{ old('doctor_contact') }}" required
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="email" name="doctor_email" id="doctor_email"
                                                ...
                                                value="{{ old('doctor_email') }}" required autocomplete="doctor_email">
                                            @error('doctor_email')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <textarea class="form-control ckeditor" id="doctor_desc" name="doctor_desc" rows="10"></textarea>
                                @error('doctor_desc')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="panel-body">
                            <div class="form-group col-md-6">
                                ...
                                <input id="doctor_address" type="text"
                                    ...
                                    name="doctor_address" value="{{ old('doctor_address') }}" required
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="doctor_city" type="text"
                                    ...
                                    value="{{ old('doctor_city') }}" required autocomplete="doctor_city">
                                @error('doctor_city')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
